Partial Class Schedule
    Partial Class XmlLoader
        Private NotInheritable Class RaceList
            ...
            Private MY_VENUE As String
            Friend Sub New(ByVal Xml As String, ByRef Venue As String)
                MY_XML = Xml
                MY_VENUE = Venue
            End Sub
            Friend Function GetListOfRaceInformation() As List(Of Instance.MeetingInformation.RaceInformation)
                ...
                For Each Race As String In Split(MY_XML, "</RACE>")
                    ...
                    Dim ListOfEntryInfo As New List(Of Instance.MeetingInformation.RaceInformation.EntryInformation)
                    ...
                    Dim NewEntryList As New EntryList(Race)
                    ListOfEntryInfo = NewEntryList.GetListOfEntryInformation
            ...
            Private Shared Sub SetClass(ByRef [Class] As String, ByVal Name As String, ByVal Xml As String)
                ...
                If [Class].Contains("/") Then [Class] = Replace([Class], "/", ".")
            ...
            Private Shared Sub SetWeather(ByRef Weather As String, ByVal Xml As String)
                ...
                End If
            End Sub
            Private Shared Sub SetVenue(ByRef Venue As String, ByVal Xml As String)
