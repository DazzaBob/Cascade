...
Namespace ModelDevelopment
    Partial Class FORM_MODELDEVELOPMENT
        Private Sub Populate_TV_Solution()
            ...
            TreeNode100.Tag = Utils.NodeTypes.BaseFolder
            ...
            TreeNode110.Tag = Utils.NodeTypes.BaseFolder
            ...
            TreeNode130.Tag = Utils.NodeTypes.BaseFolder
            ...
            TreeNode10.Tag = Utils.NodeTypes.BaseFolder
            ...
            TreeNode20.Tag = Utils.NodeTypes.BaseFolder
            ...
            TreeNode30.Tag = Utils.NodeTypes.BaseFolder
            ...
            TreeNode40.Tag = Utils.NodeTypes.BaseFolder
            ...
            TreeNode50.Tag = Utils.NodeTypes.BaseFolder
            ...
            For Each ROW As Data.DataRow In Connection.GetDataTable(CMDTEXT).Select("")
                ...
                If Nodes.Count > 0 Then
                    ...
                    Node.Tag = CType(ROW.Item("TREE_NODE_TYPE"), Utils.NodeTypes)
                    Select Case CType(ROW.Item("TREE_NODE_TYPE"), Utils.NodeTypes)
