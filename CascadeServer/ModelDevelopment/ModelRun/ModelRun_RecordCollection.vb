Namespace ModelDevelopment
    Partial Class ModelRun
        Private NotInheritable Class RecordCollection : Implements IDisposable
            ...
            Private Connection As Utils.Connection = Nothing
            ...
            Friend Sub New(ByVal Where As String, ByVal Connection As Utils.Connection, ByRef TSSLabel As ToolStripLabel)
