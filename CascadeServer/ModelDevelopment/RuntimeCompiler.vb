...
Namespace ModelDevelopment
    Friend NotInheritable Class RuntimeCompiler
        ...
        Friend Shared ReadOnly Property ModelExplorerDR(ByVal Connection As Utils.Connection, Optional ByVal ModelID As String = Nothing) As Data.DataRow()
            ...
            End Get
        End Property
        Friend Shared Function CompileCode(ByRef FormModelDevelopment As ModelDevelopment.FORM_MODELDEVELOPMENT, ByRef TabPage As UserControls.UC_TABPAGE, ByVal ModelExplorerDR() As Data.DataRow, ByVal Connection As Utils.Connection) As CodeDom.Compiler.CompilerResults
            ...
            For Each ROW As Data.DataRow In ModelExplorerDR
                ...
                If CompilerResults.Errors.Count > 0 Then
                    ...
                    For Each err As System.CodeDom.Compiler.CompilerError In CompilerResults.Errors
                        If TabPage IsNot Nothing Then Call AddErrorsToListView(err, X.ToString, TabPage)
                    ...
                    'Call Me._Messages.LogMessages(LogErrors, Utils.BroadcastTypes.Error)
        ...
        Private Shared ReadOnly Property VBClass(ByVal ModelExplorerDR() As Data.DataRow) As String
            ...
            End Get
        End Property
        Private Shared Sub AddErrorsToListView(ByVal err As System.CodeDom.Compiler.CompilerError, ErrorCount As String, ByRef TabPage As UserControls.UC_TABPAGE)
