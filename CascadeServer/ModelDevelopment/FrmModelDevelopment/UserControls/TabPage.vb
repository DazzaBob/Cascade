    ...
    Partial Class FrmModelDevelopment
        Partial Class UserControls
            Friend NotInheritable Class TabPage
                ...
                Private WithEvents MY_LINE_NUMBERS As New LineNumbers_For_RichTextBox
                ...
                Friend Sub New(ByRef FrmModelDevelopment As FORM_MODELDEVELOPMENT)
                    ...
                    MY_LINE_NUMBERS.MarginLines_Side = LineNumbers_For_RichTextBox.LineNumberDockside.Right
                    ...
                    Properties.MY_LIST_OF_TYPES.Add("GR")
                    Properties.MY_LIST_OF_TYPES.Add("H")
                    Properties.MY_LIST_OF_TYPES.Add("G")
                    ...
                    Me.Loading = False
                End Sub
                Friend Sub New(ByVal ExplorerID As String, ByRef FrmModelDevelopment As FORM_MODELDEVELOPMENT, Connection As Utils.Connection)
                ...
                Private Sub PROPERTIESGRID_PropertyValueChanged(s As Object, e As PropertyValueChangedEventArgs) Handles PROPERTIESGRID.PropertyValueChanged
                    ...
                    '
                    Dim GridItem As System.Windows.Forms.GridItem = e.ChangedItem
