Partial Friend Class Schedule
    Partial Public Class Instance
        Partial Friend Class MeetingInformation
            Friend NotInheritable Class RaceInformation : Implements IDisposable
                ...
                Friend Sub New()
                    ListOfEntryInformation = New List(Of Instance.MeetingInformation.RaceInformation.EntryInformation)
                End Sub
                ...
                Private Sub Dispose(disposing As Boolean)
                    If Not disposedValue Then
                        If disposing Then
                            ...
                            BARRIERS = Nothing
                            '
                            For Each ENTRY As Instance.MeetingInformation.RaceInformation.EntryInformation In ListOfEntryInformation
                                ENTRY.Dispose() :
                            Next
                        End If
                        ListOfEntryInformation.Clear() : ListOfEntryInformation = Nothing
                    End If
                    disposedValue = True
                End Sub
