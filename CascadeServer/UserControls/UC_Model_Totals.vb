Namespace UserControls
    Friend NotInheritable Class UC_Model_Totals
        ...
        Friend Sub New()
            ...
            Call ResetValues()
        End Sub
        Friend Sub Populate(ByVal StartOADate As String, ByVal EndOADate As String, ByVal TotalRaces As Int32, ByVal WinRaces As Int64, ByVal PlaceRaces As Int64, ByVal WinCount As Int64, PlaceCount As Int64, ProfitLossWin As Decimal, ProfitLossPlace As Decimal,
