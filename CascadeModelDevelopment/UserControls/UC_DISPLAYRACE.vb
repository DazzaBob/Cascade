...
Namespace UserControls
    Friend NotInheritable Class UC_DISPLAYRACE
        ...
        Private Sub New()
            InitializeComponent()
        End Sub
        Friend Sub New(ByVal MEETING_OADATE As String, ByVal MEETING_NUMBER As String, ByVal MEETING_COUNTRY As String, ByVal MEETING_TYPE As String, ByVal RACE_NUMBER As String)
            Me.New()
            '
