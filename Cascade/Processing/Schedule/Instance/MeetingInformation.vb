                ...
                Private Sub Dispose(disposing As Boolean)
                    If Not Me.disposedValue Then
                        If disposing Then
                            ...
                            VENUE = Nothing
                            '
                            For Each RACE As MeetingInformation.RaceInformation In Me.ListOfRaceInformation
                                RACE.Dispose() : RACE = Nothing
                            Next
                        End If
                        '
