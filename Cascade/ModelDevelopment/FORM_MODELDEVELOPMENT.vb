Namespace ModelDevelopment
    Friend NotInheritable Class FORM_MODELDEVELOPMENT
        ...
        Friend Sub New()
            ...
            '
            FORM_MODELDEVELOPMENT.Connection = New Connection()
            '
            ...
            Me.TSB_OPENFILEDIALOG.InitialDirectory = My.Settings.HomeFolder
        End Sub
        <STAThread> _
        ...
        Private Sub TSMI_OBJECTS_COPY_Click(sender As Object, e As EventArgs) Handles TSMI_OBJECTS_COPY.Click
            Try
                If InStr(Me.TVObjects.SelectedNode.Text, " ") > 0 Then
                    Clipboard.SetText(Strings.Left(Me.TVObjects.SelectedNode.Text.ToUpper(InvariantCulture), InStr(Me.TVObjects.SelectedNode.Text, " ") - 1))
                Else
        ...
        Private Sub TSBI_LISTLIVE_Click(sender As Object, e As EventArgs) Handles TSBI_LISTLIVE.Click
            ...
            MODELLIST.Populate()
        End Sub
        Friend Sub Start(ByVal TabPage As UserControls.TabPage)
            ...
            '
            Using NewSDTR As New Cascade.UserControls.SelectDayToLoad
                If NewSDTR.ShowDialog(Me) <> Windows.Forms.DialogResult.Cancel Then
                    StartDate = CInt(NewSDTR.MonthCalendar1.SelectionRange.Start.ToOADate)
                    FinishDate = CInt(NewSDTR.MonthCalendar1.SelectionRange.End.ToOADate)
                Else
            ...
            Using ModelRun As ModelDevelopment.ModelRun = New ModelDevelopment.ModelRun(CStr(StartDate), CStr(FinishDate), TabPage.Properties.ID, _
            Connection, Me.STATUSSTRIP.TSSLStatus, Me.STATUSSTRIP.TSSPBProgress)
                Try
