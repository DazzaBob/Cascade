Namespace ModelDevelopment
    Partial Class ModelRun
        Private NotInheritable Class LiveModels
            ...
            Friend Sub New(ByVal ModelExplorerDR() As Data.DataRow, ByVal Connection As Connection, ByVal CompilerResults As CodeDom.Compiler.CompilerResults)
                MY_CONNECTION = Connection
                MY_COMPILER_RESULTS = CompilerResults
                MY_MODEL_EXPLORER_DR = ModelExplorerDR
            End Sub
            Friend Sub RunLiveModels(ByVal RaceInfoRow As Data.DataRow, ByVal RI_B_DT As Data.DataTable, ByVal EI_DT As Data.DataTable, _
            ...
            ByVal EI_O_DT As Data.DataTable, ByVal EI_O_S_DT As Data.DataTable, ByVal EI_O_T_DT As Data.DataTable, ByVal EI_O_T_S_DT As Data.DataTable)
                For Each MODEL As Data.DataRow In MY_MODEL_EXPLORER_DR
                    ...
                    Dim Rslt As New Object, args() As Object = {CType(MODEL, Object), CType(RaceInfoRow, Object), CType(RI_B_DT, Object), CType(EI_DT, Object), _
                ...
                CType(EI_O_DT, Object), CType(EI_O_S_DT, Object), CType(EI_O_T_DT, Object), CType(EI_O_T_S_DT, Object)}
                    Rslt = MY_COMPILER_RESULTS.CompiledAssembly.GetType("Models").InvokeMember("_" & CStr(MODEL.Item("MODEL_EXPLORER_ID")), System.Reflection.BindingFlags.InvokeMethod Or System.Reflection.BindingFlags.Public Or System.Reflection.BindingFlags.Static, Nothing, Nothing, args, InvariantCulture)
