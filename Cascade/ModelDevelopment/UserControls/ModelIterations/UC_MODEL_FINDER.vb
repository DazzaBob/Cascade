...
Namespace ModelDevelopment.UserControls.ModelIterations
    Friend NotInheritable Class UC_MODEL_FINDER
        ...
        Private PASSEDIN_CONNECTION As Connection
        '
        ...
        Private Sub Iteration(ByVal ITERATION_ROW As Data.DataRow)
            ...
            '
            Using ModelRun As ModelDevelopment.ModelRun = New ModelDevelopment.ModelRun(StartDate, FinishDate, MY_FRM_MODEL_ITERATIONS.MODELEXPLORER_DR.Item("MODEL_EXPLORER_ID").ToString, _
            PASSEDIN_CONNECTION, MY_STATUSSTRIP.TSSLStatus, MY_STATUSSTRIP.TSSPBProgress, MY_FRM_MODEL_ITERATIONS.MODELEXPLORER_DR)
        ...
        Private Sub CreateModel(ByVal Results_DT As Data.DataTable, ByVal Iteration_Row As Data.DataRow)
            ...
            CMDTEXT += "VALUES (-4, 2, " & CStr(NodeTypes.Model) & ", N'Evaluated', N'" & this_ModelName & "', "
