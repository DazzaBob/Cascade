Namespace ServerUI
    Partial Class Messages
        Friend NotInheritable Class InMemory
            Private Shared MY_DATATABLE As Data.DataTable = Nothing
            Private Shared LockObject As New Object  ' Just so we dont try reading and writing the table at the same time.
            Private Sub New()
                ' Just so the compiler doesnt create a default constructor
            End Sub
            Friend Shared ReadOnly Property GetDataTable() As Data.DataTable
                Get
                    If MY_DATATABLE Is Nothing Then Call SetDataTableColumns()
                    Return MY_DATATABLE
                End Get
            End Property
            Friend Shared Sub AddNew(ByVal dateTime As Date, ByVal logthis As String)
                SyncLock LockObject
            ...
            Friend Shared Sub Delete(ByVal inclause As String)
                ...
                End SyncLock
            End Sub
            Friend Shared Sub SetDataTableColumns()
