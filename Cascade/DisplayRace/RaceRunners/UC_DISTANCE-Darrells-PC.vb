Namespace DisplayRace.RaceRunners
    Friend NotInheritable Class UC_DISTANCE
        ...
        Private Sub ME_Load(sender As Object, e As EventArgs) Handles Me.Load
            For Each ENTRY_ROW As Data.DataRow In StoredProcedures.JoinedDataTable(MY_MEETING_OADATE, MY_MEETING_NUMBER, MY_RACE_NUMBER, "DISTANCE", MY_CONNECTION).Select("")
                Using DGVRow As Windows.Forms.DataGridViewRow = New Windows.Forms.DataGridViewRow
                    ...
                    '
                    If Not IsDBNull(ENTRY_ROW.Item("BARRIER")) Then
                        DGVRow.Cells(Me.DGV_BARRIER.Index).Value = CShort(ENTRY_ROW.Item("BARRIER"))
                    Else
                        DGVRow.Cells(Me.DGV_BARRIER.Index).Value = CShort(ENTRY_ROW.Item("NUMBER"))
                    End If
                    DGVRow.Cells(Me.DGV_CLASS.Index).Value = CDec(ENTRY_ROW.Item("CLASS"))
                    DGVRow.Cells(Me.DGV_BARRIER.Index).Tag = CShort(ENTRY_ROW.Item("SCRATCHED"))
                    '
                    DGVRow.Cells(Me.DGV_LASTRAN.Index).Value = CInt(ENTRY_ROW.Item("LAST_RAN"))
                    DGVRow.Cells(Me.DGV_LASTSPEED.Index).Value = CDec(ENTRY_ROW.Item("LAST_SPEED"))
                    DGVRow.Cells(Me.DGV_LASTDISTANCEBEHIND.Index).Value = CDec(ENTRY_ROW.Item("LAST_DISTANCE_BEHIND"))
                    '
                    ...
                    '
                    DGVRow.Cells(Me.DGV_DSLR.Index).Value = CInt(ENTRY_ROW.Item("LAST_DSLR"))
                    DGVRow.Cells(Me.DGV_DISTANCETORUN.Index).Value = CDec(ENTRY_ROW.Item("DTR"))
