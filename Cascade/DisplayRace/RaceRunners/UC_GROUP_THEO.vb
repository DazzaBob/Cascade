Namespace DisplayRace.RaceRunners
    Friend NotInheritable Class UC_GROUP_THEO
        ...
        End Sub
        Private Sub UC_GROUP_THEO_Load(sender As Object, e As EventArgs) Handles Me.Load
            For Each ENTRY_ROW As Data.DataRow In StoredProcedures.JoinedDataTable(MY_MEETING_OADATE, MY_MEETING_NUMBER, MY_RACE_NUMBER, "GROUP_THEO", MY_CONNECTION).Select("")
