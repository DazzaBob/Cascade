Namespace DisplayRace.RaceRunners
    Friend NotInheritable Class UC_OVERALL
        ...
        End Sub
        Private Sub UC_OVERALL_Load(sender As Object, e As EventArgs) Handles Me.Load
            For Each ENTRY_ROW As Data.DataRow In StoredProcedures.JoinedDataTable(MY_MEETING_OADATE, MY_MEETING_NUMBER, MY_RACE_NUMBER, "OVERALL", MY_CONNECTION).Select("")
                UC_BASE.Populate(ENTRY_ROW)
