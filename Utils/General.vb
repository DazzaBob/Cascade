Public Module General
    Public Const MinOADate As Integer = 39766
    ...
    <Flags>
    Public Enum Requests As Integer
        None = 0
        Connect = 1
        Disconnect = 2
        DataTransfer = 3
    ...
    Public ReadOnly Property ElapsedTime(StopWatch As Stopwatch) As String
        ...
        End Get
    End Property
    Public Sub LogThreadDetails(Thread As Threading.Thread, Messages As Messages)
        SyncLock LockObject
            ...
            Call Messages.LogMessages(Broadcast, BroadcastTypes.Log, Nothing)
        End SyncLock
    End Sub
