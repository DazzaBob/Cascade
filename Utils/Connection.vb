Public NotInheritable Class Connection : Implements IDisposable
    ...
    Private ReadOnly MESSAGES As Messages
    Public Sub New(ConnectionString As String)
        Me.MY_CONNECTION = New SqlClient.SqlConnection(ConnectionString)
        Me.MY_CONNECTION.Open()
    End Sub
    Public Sub New(ConnectionString As String, Messages As Messages)
...
#Region "    Private Routines "
    Private Sub ExceptionThrown(ex As Exception, CommandText As String)
        ...
        If Me.MESSAGES IsNot Nothing Then
            Call MESSAGES.LogMessages(Log, BroadcastTypes.Error)
        Else
...
#Region "    IDisposable Support "
    ...
    Friend Sub Dispose(disposing As Boolean)
        If Not disposedValue Then
            If disposing Then
                If MY_CONNECTION IsNot Nothing Then MY_CONNECTION.Dispose() ' Dont set to nothing. Let .net handle the release.
            End If
        End If
        disposedValue = True
    End Sub
